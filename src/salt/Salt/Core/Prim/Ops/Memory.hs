...
primOpsMemory
 = [ PP { name  = "sizeOf"
   ...
   , PO { name  = "allocPtr"
        , tsig  = [("r", TRegion), ("a", TData)] :*> TPtr "r" "a"
        , teff  = [TMemory]
   ...
   , PO { name  = "writePtr"
        , tsig  = [("r", TRegion), ("a", TData)] :*> [TPtr "r" "a", "a"] :-> []
        , teff  = [TMemory]
   ...
   , PP { name  = "castPtr"
        , tsig  = [("r", TRegion), ("a", TData), ("b", TData)] :*> [TPtr "r" "a"] :-> [TPtr "r" "b"]
