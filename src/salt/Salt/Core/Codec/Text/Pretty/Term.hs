...
instance Pretty c TermKey where
 ppr _ mk
  = case mk of
        ...
        MKProcEndWith   -> text "##proc'end'with"

        MKStmtProc      -> text "##stmt'proc"
        MKStmtNest      -> text "##stmt'nest"
        MKStmtIf        -> text "##stmt'if"
        MKStmtCase      -> text "##stmt'case"
        MKStmtLoop      -> text "##stmt'loop"
        MKStmtUpdate    -> text "##stmt'update"
        MKStmtCall      -> text "##stmt'call"
        MKStmtBreak     -> text "##stmt'break"
        MKStmtContinue  -> text "##stmt'continue"
        MKStmtReturn    -> text "##stmt'return"
