...
-- because the new Prelude claimed some operators traditionally used by
...
module Salt.Data.PrettyPrint (
   ...
   -- * Operator names
   paste, pspace, psoftline, psoftbreak, pline, plinebreak,
...
psoftbreak :: Doc -> Doc -> Doc
psoftbreak x y  = x <> softbreak <> y
...
plinebreak :: Doc -> Doc -> Doc
plinebreak x y  = x <> linebreak <> y
